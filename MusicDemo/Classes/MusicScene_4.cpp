...
Scene* MusicLayer_4::createScene()
{
...
bool MusicLayer_4::init()
{
    ...
    MenuItemSprite *startMenuItem = MenuItemSprite::create(startSpriteNormal,
                                                           startSpriteSelected,
                                                           CC_CALLBACK_1(MusicLayer_4::menuItemStartCallback, this));
    ...
    MenuItemImage *settingMenuItem = MenuItemImage::create(
                                                           "setting-up.png",
                                                           "setting-down.png",
                                                           CC_CALLBACK_1(MusicLayer_4::menuItemSettingCallback, this));
    ...
    MenuItemImage *helpMenuItem = MenuItemImage::create(
                                                        "help-up.png",
                                                        "help-down.png",
                                                        CC_CALLBACK_1(MusicLayer_4::menuItemHelpCallback, this));
...
void MusicLayer_4::menuItemSettingCallback(Ref* pSender)
{
    auto sc = Setting_4::createScene();
    auto reScene = TransitionJumpZoom::create(1.0f, sc);
    Director::getInstance()->pushScene(reScene);
    SimpleAudioEngine::getInstance()->playEffect("sound/Blip.wav");
}

void MusicLayer_4::menuItemHelpCallback(Ref* pSender)
{
...
void MusicLayer_4::menuItemStartCallback(Ref* pSender)
{
    MenuItem* item = (MenuItem*)pSender;
...
void MusicLayer_4::onEnter()
{
    Layer::onEnter();
    log("HelloWorld onEnter");		
}

void MusicLayer_4::onEnterTransitionDidFinish()
{
...
void MusicLayer_4::onExit()
{
    Layer::onExit();
    log("HelloWorld onExit");
}

void MusicLayer_4::onExitTransitionDidStart()
{
    Layer::onExitTransitionDidStart();
    log("HelloWorld onExitTransitionDidStart");
}

void MusicLayer_4::cleanup()
{
    Layer::cleanup();
