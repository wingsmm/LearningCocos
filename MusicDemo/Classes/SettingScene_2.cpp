...
bool Setting_2::init()
{
    ...
    auto soundToggleMenuItem = MenuItemToggle::createWithCallback(CC_CALLBACK_1(Setting_2::menuSoundToggleCallback, this),
                                                                  soundOffMenuItem,
                                                                  soundOnMenuItem,
                                                                  NULL);
    ...
    auto musicOffMenuItem  = MenuItemImage::create(
                                                   "off.png",
                                                   "off.png");
    auto musicToggleMenuItem = MenuItemToggle::createWithCallback(CC_CALLBACK_1(Setting_2::menuMusicToggleCallback, this),
                                                                  musicOffMenuItem,
                                                                  musicOnMenuItem,
                                                                  NULL );
    ...
    auto okMenuItem  = MenuItemImage::create(
                                             "ok-down.png",
                                             "ok-up.png",
                                             CC_CALLBACK_1(Setting_2::menuOkCallback, this));
...
void Setting_2::menuOkCallback(Ref* pSender)
{
    Director::getInstance()->popScene();
}

void Setting_2::menuSoundToggleCallback(Ref* pSender)
{
...
void Setting_2::menuMusicToggleCallback(Ref* pSender)
{
...
void Setting_2::onEnterTransitionDidFinish()
{
...
void Setting_2::onExit()
{
    Layer::onExit();
    log("Setting onExit");	
}

void Setting_2::onExitTransitionDidStart()
{
    Layer::onExitTransitionDidStart();
    log("Setting onExitTransitionDidStart");
}

void Setting_2::cleanup()
{
    Layer::cleanup();
    log("Setting cleanup");	
