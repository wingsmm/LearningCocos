...
#ifndef __MusicDemo__MusicScene_3__
#define __MusicDemo__MusicScene_3__
...
class MusicLayer_3 : public cocos2d::Layer
{
public:
    ...
    CREATE_FUNC(MusicLayer_3);
};

#endif /* defined(__MusicDemo__MusicScene_3__) */
