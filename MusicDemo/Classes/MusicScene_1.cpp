...
USING_NS_CC;
Scene* MusicLayer_1::createScene()
{
...
bool MusicLayer_1::init()
{
    ...
    MenuItemSprite *startMenuItem = MenuItemSprite::create(startSpriteNormal,
                                                           startSpriteSelected,
                                                           CC_CALLBACK_1(MusicLayer_1::menuItemStartCallback, this));
    ...
    MenuItemImage *settingMenuItem = MenuItemImage::create(
                                                           "setting-up.png",
                                                           "setting-down.png",
                                                           CC_CALLBACK_1(MusicLayer_1::menuItemSettingCallback, this));
    ...
    MenuItemImage *helpMenuItem = MenuItemImage::create(
                                                        "help-up.png",
                                                        "help-down.png",
                                                        CC_CALLBACK_1(MusicLayer_1::menuItemHelpCallback, this));
...
void MusicLayer_1::menuItemSettingCallback(Ref* pSender)
{
    auto sc = Setting_1::createScene();
    auto reScene = TransitionJumpZoom::create(1.0f, sc);
    Director::getInstance()->pushScene(reScene);
}

void MusicLayer_1::menuItemHelpCallback(Ref* pSender)
{
    MenuItem* item = (MenuItem*)pSender;
    log("Touch Help %p", item);
}

void MusicLayer_1::menuItemStartCallback(Ref* pSender)
{
    MenuItem* item = (MenuItem*)pSender;
    log("Touch Start %p", item);
}

void MusicLayer_1::onEnter()
{
    Layer::onEnter();
...
void MusicLayer_1::onEnterTransitionDidFinish()
{
    Layer::onEnterTransitionDidFinish();
    log("HelloWorld onEnterTransitionDidFinish");
}

void MusicLayer_1::onExit()
{
    Layer::onExit();
...
void MusicLayer_1::onExitTransitionDidStart()
{
