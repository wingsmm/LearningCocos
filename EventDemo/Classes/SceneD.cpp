...
bool DLayer::init()
{
    ...
    auto staticLabel = Label::createWithBMFont("fonts/fnt9.fnt", "Scene D");
    ...
    auto pItmMenu2 = MenuItemLabel::create(pItmLabel2, CC_CALLBACK_1(DLayer::menReturnPreviousScene, this));
...
void DLayer::menReturnPreviousScene(Ref* pSender)
{
