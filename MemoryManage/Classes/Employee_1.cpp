...
Employee_1::Employee_1()
{
    this->first = __String::create("Zhang");
    this->last = __String::create("Bo");
    this->emails = __Array::create(__String::create("2711765586@qq.com"), NULL);
    this->phones = __Array::create(__String::create("18911765586"), NULL);
